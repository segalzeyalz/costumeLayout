...
const layoutsArr = [
        ...
        gridStructure: [
          ...
          gridStructure: [
              ...
              {i: 'c', x: 7, y: 0, w: 1, h: 2, static: true, comps:[]},
              {i: 'd', x: 8, y: 0, w: 3, h: 2, static: true, comps:[]},
              {i: 'e', x: 3, y: 2, w: 8, h: 3, static: true, comps:[]},
              {i: 'f', x: 0, y: 3, w: 3, h: 3, static: true, comps:[]},
              {i: 'g', x: 3, y: 5, w: 8, h: 1, static: true, comps:[]},
            ...
            { id:3,
              gridStructure: [
                ...
                {i: 'b', x: 8, y: 0, w: 1, h: 4, static: true, comps:[]},
                {i: 'c', x: 0, y: 3, w: 8, h: 1, static: true, comps:[]},
                {i: 'd', x: 0, y: 4, w: 9, h: 1, static: true, comps:[]},
                  ]},
            { id:4,
              gridStructure: [
                    {i: 'a', x: 0, y: 0, w: 6, h: 2, static: true, comps:[]},
                    {i: 'b', x: 6, y: 0, w: 3, h: 4, static: true, comps:[]},
                    {i: 'c', x: 0, y: 2, w: 6, h: 2, static: true, comps:[]},
                    {i: 'd', x: 0, y: 4, w: 9, h: 1, static: true, comps:[]},
                ]},
                { id:5,
                gridStructure: [
                    {i: 'a', x: 0, y: 0, w: 9, h: 3, static: true, comps:[]},
                    {i: 'b', x: 0, y: 3, w: 9, h: 1, static: true, comps:[]},
                    {i: 'c', x: 0, y: 4, w: 5, h: 1, static: true, comps:[]},
                    {i: 'd', x: 5, y: 4, w: 4, h: 1, static: true, comps:[]},
                ]},
                    { id:6,
                    gridStructure: [
                        {i: 'a', x: 0, y: 0, w: 3, h: 4, static: true, comps:[]},
                        {i: 'b', x: 3, y: 0, w: 6, h: 4, static: true, comps:[]},
                        {i: 'c', x: 0, y: 4, w: 5, h: 1, static: true, comps:[]},
                        {i: 'd', x: 5, y: 4, w: 4, h: 1, static: true, comps:[]},
                ]}
];
